<?php
include 'C:\xampp\htdocs\2A34\Ecc_gestion_user\Controller\userC.php';
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h4 class="text-blue h4">Utilisateurs</h4>
					...
					<table class="data-table table stripe hover nowrap">
						<div class="dt-buttons btn-group flex-wrap"> 
							...
							<button class="btn btn-secondary buttons-pdf buttons-html5" tabindex="0" aria-controls="DataTables_Table_2" type="button">
								<span>PDF</span>
							</button> <button class="btn btn-secondary buttons-print" tabindex="0" aria-controls="DataTables_Table_2" type="button">
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<form method="POST" action="infosusers.php">

													<a class="dropdown-item" href="infosusers.php?email=<?= $user['id']; ?>" name="email"><i class="dw dw-eye"></i> Détails</a>
											
												</form>
												<form method="POST" action="_UptdateUser.php">

													<a class="dropdown-item" href="_UptdateUser.php?email=<?= $user['id']; ?>" name="email"><i class="dw dw-edit2"></i> Modifier</a>
